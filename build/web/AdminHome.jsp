...
<!--      <div class="image" style="max-width:433px" >
          <img class="slide" src="images/image1.jpg" style="width:100%">
          <img class="slide" src="images/image5.jpg" style="width:100%">
          <img class="slide" src="images/image9.jpg" style="width:100%">
      </div>-->
  <br/>
...
<div id="container1">
  <div class = "info1">
      <div class = "info11">
            ...
            <a class="anc" href = "search.html"> <button class ="btn"> Search</button></a>
        </div>
        <div class = "info12">
            <p><h1><img src = "images/user.png" class = "img"> User </h1>
            <h3> User info here</h3>
            <a class="anc" href = "profile.html"><button class ="btn"> User</button></a>
        </div>
    </div>
    <div class = "info2">
        <div class = "info21">
            ...
            <a  class="anc" href = "Admin.jsp"><button class ="btn"> Check Your Schedule</button></a>
        </div>
        <div class = "info22">
